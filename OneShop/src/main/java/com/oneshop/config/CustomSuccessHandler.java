...
import org.springframework.security.oauth2.core.oidc.user.OidcUser; // Quan trọng
import org.springframework.security.oauth2.core.user.OAuth2User; // Quan trọng
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        try {
            if (principal instanceof UserDetails userDetails) {
                ...
                // **Priority 1: Get 'internal_username' from attributes**
                ...
                if (StringUtils.hasText(identifierForJwt)) {
                    ...
                    // **Priority 2: Get email directly from OidcUser object**
                ...
                if (StringUtils.hasText(identifierForJwt)) {
                    ...
                    // **Priority 2: Get 'email' from attributes**
            ...
            // Final check should not be needed if logic above is correct, but keep for safety
            if (!StringUtils.hasText(identifierForJwt)) {
